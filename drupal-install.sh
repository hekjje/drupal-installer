...
then
  ...
  drush si -y --db-url=mysql://$mysqlusernmae:$mysqlpassword@$mysqlhost/$mysqldatabase --account-name=$drupaladminusernmae --account-pass=$drupaladminpassword --account-mail=$drupaladminmail
